...
Information on this dataset (hmnist_28_28_RGB.csv.zip):

1. Source: https://www.kaggle.com/kmader/skin-cancer-mnist-ham10000
2. Title: Skin Cancer MNIST: HAM10000
3. Columns: 28x28 x 3  = (784 [pixel] x 3 [RGB]) + 1 (label) = 2353 columns, each representing an RGB pixel value of the image
4. Label Column: 7 possible values
5. Rows: 10015 data records representing 10015 dermatoscopic images
